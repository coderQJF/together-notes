        ...
        <view class="form-card">
          <view class="form-row">
            ...
            <view class="form-list">
              <text v-for="(result, index) in match.homeForm" :key="index" :class="['form-dot', formClass(result)]">{{ result }}</text>
            </view>
          </view>
          <view class="form-row">
            <text class="form-team">{{ match.awayShort }}</text>
            <view class="form-list">
              <text v-for="(result, index) in match.awayForm" :key="index" :class="['form-dot', formClass(result)]">{{ result }}</text>
            </view>
          </view>
        </view>
      </view>
