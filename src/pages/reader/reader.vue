...
<template>
  <view class="shell" :class="`theme-${settings.theme}`">
    ...
    <view v-if="error" class="state-card"><text class="state-title">无法打开</text><text>{{ error }}</text><button @click="backToLibrary">返回书架</button></view>
    ...
    <template v-else-if="book && chapter">
      ...
      <view class="reader-copy" :style="readingStyle"><text>{{ chapter.content }}</text></view>
