...
<template>
  <view class="shell">
    ...
    <view v-else class="form">
      ...
      <textarea v-model="draft.content" maxlength="50000" placeholder="文字、清单，或者想对她说的话…" disable-default-padding />
